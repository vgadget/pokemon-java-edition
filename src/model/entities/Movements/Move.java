...
public abstract class Move implements Entity<String> {
    ...
    public abstract boolean makeEffect(BattleModel battleModel, Pokemon from, Pokemon to);

    public boolean fails() {
        return new Random().nextInt(100) <= getPrecision();
    }

    public void setFrontAnimation(Sprite frontAnimation) {
        this.frontAnimation = frontAnimation;
    }

    public void setBackAnimation(Sprite backAnimation) {
        this.backAnimation = backAnimation;
    }
