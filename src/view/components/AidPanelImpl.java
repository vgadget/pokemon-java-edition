...
public class AidPanelImpl extends JPanel implements AidView {
    ...
    private boolean enableAudioDescriptions;
    ...
    public boolean isEnabledAudioDescription() {
        return Narrator.getInstance().isEnabled() && enableAudioDescriptions;
    }

    @Override
    public void setEnableAudioDescriptions(boolean enableAudioDescriptions) {
        this.enableAudioDescriptions = enableAudioDescriptions;
    }
    ...
    public synchronized void addAidComponent(Component component) {
    ...
    public synchronized void removeAudibleDescription() {

        this.additionalDescriptions.removeAll(this.additionalDescriptions);
