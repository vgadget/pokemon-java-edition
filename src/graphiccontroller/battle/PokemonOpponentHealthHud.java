...
public class PokemonOpponentHealthHud extends JPanel {
    ...
    private BattleGraphicControllerImpl mainControler;
    ...
    public PokemonOpponentHealthHud(Dimension frameDimension, String name, int level, int sex, int currentHp, int maxHp, boolean isCatched, BattleGraphicControllerImpl mainControler) {
    ...
    public PokemonOpponentHealthHud(Dimension frameDimension, BattleGraphicControllerImpl mainControler) {
